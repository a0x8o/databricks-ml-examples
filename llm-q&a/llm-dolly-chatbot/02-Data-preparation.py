...
# MAGIC To run this demo, just select the cluster `dbdemos-llm-dolly-chatbot-alex_barreto` from the dropdown menu ([open cluster configuration](https://adb-984752964297111.11.azuredatabricks.net/#setting/clusters/1206-212706-dxn6u78s/configuration)). <br />
...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=984752964297111&notebook=%2F02-Data-preparation&demo_name=llm-dolly-chatbot&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fllm-dolly-chatbot%2F02-Data-preparation&version=1">
