...
# MAGIC To run this demo, just select the cluster `dbdemos-llm-rag-chatbot-alex_barreto` from the dropdown menu ([open cluster configuration](https://adb-984752964297111.11.azuredatabricks.net/#setting/clusters/1206-212718-wqlcnbq2/configuration)). <br />
...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=984752964297111&notebook=%2F01-Data-Preparation-and-Index&demo_name=llm-rag-chatbot&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fllm-rag-chatbot%2F01-Data-Preparation-and-Index&version=1">

# COMMAND ----------

# DBTITLE 1,Install required external libraries 
# MAGIC %pip install "git+https://github.com/mlflow/mlflow.git@gateway-migration" lxml==4.9.3 transformers==4.30.2 langchain==0.0.344 databricks-vectorsearch==0.22
